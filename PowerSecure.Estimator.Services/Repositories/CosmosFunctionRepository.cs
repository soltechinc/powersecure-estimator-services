    ...
    public class CosmosFunctionRepository : IFunctionRepository, IInstructionSetRepository
    {
        ...
        public async Task<int> Import(JToken jToken)
        {
            ...
            foreach (var child in jToken.Children())
            {
                ...
                {
                    var doc = _dbClient.CreateDocumentQuery<Function>(UriFactory.CreateDocumentCollectionUri(databaseId: _databaseId, collectionId: _collectionId), new FeedOptions { EnableCrossPartitionQuery = false })
