...
{
    public class GreaterThanOrEqualPrimitive : IFunction
    {
        public string Name => ">=";
        ...
        public object Invoke(object[] parameters, IReferenceDataRepository referenceDataRepository)
        {
            ...
            {
                case 1:
                    return CheckGreaterThanOrEqual(parameters[0].ToObjectArray());
                case 2:
                    {
                ...
                default:
                    return CheckGreaterThanOrEqual(parameters);
            }
        }

        private static bool CheckGreaterThanOrEqual(IEnumerable<object> objects)
        {
