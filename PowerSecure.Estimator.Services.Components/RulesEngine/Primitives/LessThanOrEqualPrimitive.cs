...
{
    public class LessThanOrEqualPrimitive : IFunction
    {
        public string Name => "<=";
        ...
        public object Invoke(object[] parameters, IReferenceDataRepository referenceDataRepository)
        {
            ...
            {
                case 1:
                    return CheckLessThanOrEqual(parameters[0].ToObjectArray());
                case 2:
                    {
                ...
                default:
                    return CheckLessThanOrEqual(parameters);
            }
        }

        private static bool CheckLessThanOrEqual(IEnumerable<object> objects)
        {
